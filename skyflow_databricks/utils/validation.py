...
def validate_prefix(prefix: str) -> Tuple[bool, Optional[str]]:
    """Validate prefix name meets Databricks naming requirements."""
    if not prefix:
    ...
    # Reserved keywords
    reserved = ['system', 'information_schema', 'default', 'main', 'hive_metastore']
...
def validate_warehouse_id(warehouse_id: str) -> Tuple[bool, Optional[str]]:
    ...
    # Basic format validation - Databricks warehouse IDs are typically UUIDs or similar
